...
export default function Contact() {
  ...
  return (
    <>
      ...
      <section className="min-h-[100dvh] pt-28 md:pt-24 pb-16 px-6 md:px-8 relative z-10">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-16 px-2 sm:px-0">
            {/* Contact Info */}
