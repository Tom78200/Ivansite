  ...
  return (
    <>
      ...
      <section className="min-h-[100dvh] pt-28 md:pt-24 pb-16 px-0 md:px-8 relative z-10 overflow-x-hidden">
        <div className="max-w-6xl mx-auto w-full px-0 md:px-0">
          <div
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-16 px-0">
            ...
            <div className="space-y-8 w-full">
              <div className="bg-white/5 md:backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10 ml-4 mr-6 md:mx-0 w-[auto]">
            ...
            <div className="w-full">
              <form
                ...
                className="bg-white/5 md:backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10 space-y-6 ml-4 mr-6 md:mx-0 w-[auto]"
              >
